...
VALUES
     (1, 1, '2023-04-09', 23, '2023-04-16',1, SYSDATE(6), SYSDATE(6))
    ,(1, 1, '2023-04-18', 21, '2023-04-25',1, SYSDATE(6), SYSDATE(6))
    ,(1, 2, '2023-04-09', 12, '2023-04-16',1, SYSDATE(6), SYSDATE(6))
    ,(1, 3, '2023-04-10', 11, '2023-04-17',1, SYSDATE(6), SYSDATE(6))
    ,(2, 4, '2023-04-14', 16, '2023-04-21',1, SYSDATE(6), SYSDATE(6))
    ,(2, 4, '2023-04-21', 23, '2023-04-28',1, SYSDATE(6), SYSDATE(6))
    ,(2, 5, '2023-04-14', 45, '2023-04-21',1, SYSDATE(6), SYSDATE(6))
    ,(2, 6, '2023-04-14', 30, '2023-04-21',1, SYSDATE(6), SYSDATE(6))
    ,(3, 7, '2023-04-12', 12, '2023-04-19',1, SYSDATE(6), SYSDATE(6))
    ,(3, 7, '2023-04-19', 23, '2023-04-26',1, SYSDATE(6), SYSDATE(6))
    ,(3, 8, '2023-04-10', 12, '2023-04-17',1, SYSDATE(6), SYSDATE(6))
    ,(3, 9, '2023-04-11', 1, '2023-04-18',1, SYSDATE(6), SYSDATE(6))
    ,(4, 10, '2023-04-16', 24, '2023-04-30',1, SYSDATE(6), SYSDATE(6))
    ,(5, 11, '2023-04-10', 47, '2023-04-17',1, SYSDATE(6), SYSDATE(6))
    ,(5, 11, '2023-04-19', 60, '2023-04-26',1, SYSDATE(6), SYSDATE(6))
    ,(5, 12, '2023-04-11', 45, NULL,1, SYSDATE(6), SYSDATE(6))
    ,(5, 13, '2023-04-12', 23, NULL,1, SYSDATE(6), SYSDATE(6));